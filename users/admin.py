...
class CustomUserAdmin(UserAdmin):
    model = User
    list_display = ('email', 'firstName', 'lastName','phone_number', 'isAdmin', 'is_staff', 'is_active', 'is_customer')
    ...
    fieldsets = (
        ...
        ('Personal Info', {'fields': ('firstName', 'lastName', 'birthDate', 'phone_number')}),  # Kişisel bilgiler
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'password1', 'password2', 'firstName', 'lastName', 'birthDate', 'phone_number', 'isAdmin', 'is_staff', 'is_active', 'is_customer')},
        ),
    )
